      ...
      <div class="info-section">
        ...
        <div class="info-list">
          ...
          <div class="info-item">
            ...
            <span class="info-value">{{ addressList[0] ? addressList[0].userAddress : '未填写' }}
              <i class="el-icon-edit-outline edit-icon" @click="showAddressDialog(addressList[0] ? addressList[0].addressId: null)"></i>
            </span>
          </div>

          <!-- 备选地址 -->
          <div class="info-item">
            <span class="info-label">备选地址</span>
            <span class="info-value">{{ addressList[1] ? addressList[1].userAddress : '未填写' }}
              <i class="el-icon-edit-outline edit-icon"
                 @click="showAddressDialog(addressList[1] ? addressList[1].addressId: null)"></i>
            </span>
          </div>
        </div>
        ...
        <!-- 地址编辑对话框 -->
        <el-dialog
          :visible.sync="showAddressEditor"
          title="修改地址"
          width="30%"
          class="apple-dialog"
          center>
          <div class="dialog-content">
            <div class="input-group">
              ...
              <el-input
                ...
                class="apple-input"
                clearable>
                <i slot="prefix" class="el-icon-location-outline input-icon"></i>
              </el-input>
            </div>
          </div>
          <span slot="footer" class="dialog-footer">
            <el-button class="apple-button" @click="showAddressEditor = false">取消</el-button>
            <el-button
...
export default {
  ...
  methods: {
    ...
    async saveAddress() {
      this.form.addressId = this.editingAddressIndex
      this.form.userAddress = this.tempAddress
